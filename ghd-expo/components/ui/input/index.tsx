...
const inputStyle = tva({
    base: 'border-background-300 flex-row overflow-hidden content-center focus:border-secondary-700 data-[hover=true]:border-outline-400 data-[focus=true]:border-secondary-700 data-[focus=true]:hover:border-secondary-700 data-[disabled=true]:opacity-40 data-[disabled=true]:hover:border-background-300 items-center',
